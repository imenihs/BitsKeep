...
<div id="app" data-page="stock-alert" class="p-6 max-w-5xl mx-auto">
  ...
  <!-- 発注リストモーダル -->
  <div v-if="orderModal" class="fixed inset-0 bg-black/50 flex items-center justify-center z-50">
    <div class="bg-[var(--color-bg)] rounded-xl shadow-xl w-full max-w-2xl mx-4 max-h-[80vh] overflow-y-auto">
