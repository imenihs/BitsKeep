    ...
    <div class="flex-1 min-w-0 space-y-12 text-sm leading-relaxed">
      ...
      <section id="tools">
        ...
        <ul class="list-disc list-inside space-y-1 mb-5 opacity-80">
          ...
          <li>VR調整ありは、出力下限/上限と指定した基準VR値から R上/R下 の固定抵抗候補を出し、負荷込みで端点を計算します。基準VR値は設計で使うVR素子の公称値として固定し、10kΩ指定時に200Ωのような大きく異なるVR値は採用しません。候補値ソース、許容誤差、総抵抗範囲はVR調整なしと同じ入力を使います</li>
