  ...
  <div class="flex gap-10">
    ...
    <div class="flex-1 min-w-0 space-y-12 text-sm leading-relaxed">
      ...
      <section id="tools">
        ...
        <p class="mb-2 opacity-80">抵抗/容量ネットワーク、分圧、可変抵抗の計算を同じ画面で扱います。設計解析ツールハブにも受動部品ネットワーク/分圧設計として表示され、専用画面は候補比較と探索作業の深リンクとして扱います。</p>
        <ul class="list-disc list-inside space-y-1 mb-5 opacity-80">
          <li>上位タブはネットワーク探索、分圧、可変抵抗です</li>
          <li>ネットワーク探索タブは抵抗/容量ネットワーク専用です。分圧UIは置かず、抵抗と容量で直列/並列の合成式を切り替えます</li>
          <li>通常分圧とVR分圧の正本は /tools/network の分圧タブです。設計解析ツールのNTC/PTC温度変換は温度スイープ、ADCコード表、線形化、プルアップ/プルダウン候補に責務を絞り、通常分圧/VR分圧候補は同じ分圧エンジンを使います</li>
        ...
        <ul class="list-disc list-inside space-y-1 opacity-80">
          ...
          <li>抵抗/容量ネットワーク探索は設計解析ツール群の一部です。通常分圧/VR分圧は /tools/network を正本にし、NTC/PTC温度変換は温度モデルとADC変換へ責務を分けます</li>
