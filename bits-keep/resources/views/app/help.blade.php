  ...
  <div class="flex gap-10">
    ...
    <div class="flex-1 min-w-0 space-y-12 text-sm leading-relaxed">
      ...
      <section id="tools">
        ...
        <p class="mb-2 opacity-80">抵抗/容量ネットワーク、分圧、可変抵抗の計算を同じ画面で扱います。情報設計上は設計解析ツール配下の受動部品ネットワーク/分圧設計で、専用画面は候補比較と探索作業の深リンクとして扱います。</p>
        <ul class="list-disc list-inside space-y-1 mb-5 opacity-80">
          <li>上位タブはネットワーク探索、分圧、可変抵抗です</li>
          <li>ネットワーク探索タブは抵抗/容量ネットワーク専用です。分圧UIは置かず、抵抗と容量で直列/並列の合成式を切り替えます</li>
          <li>通常分圧とVR分圧の正本はこの分圧タブです。設計解析ツールのセンサ分圧/NTCは温度スイープ、ADCコード表、線形化、プルアップ/プルダウン候補に責務を絞り、電気的な分圧計算は同じ分圧エンジンを使います</li>
        ...
        <ul class="list-disc list-inside space-y-1 opacity-80">
          ...
          <li>抵抗/容量ネットワーク探索は設計解析ツール群の一部です。通常分圧/VR分圧はネットワーク探索側へ統合し、NTC/PTC側は温度モデルとADC変換へ責務を分けます</li>
          ...
          <li>コネクタ参照はコネクタ設計/ピン配置へ再定義します。USB、D-sub、IDC、ピンヘッダ、JST、Molex、RJ45などの標準テンプレートに加え、ユーザー登録の写真、図、データシート、ピン番号規則、定格、相手側部品を扱います</li>
          <li>コネクタ設計/ピン配置では、写真/図つきピンマップ、信号名、電圧、電流、並列電源ピン、シールド、差動ペア、ケーブルAWG、derating、BOM/シルク注記を確認し、定格根拠や視点図が不足する場合はPASSにしません</li>
